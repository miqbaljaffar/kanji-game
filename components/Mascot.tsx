...
export function Mascot({ state }: MascotProps) {
  return (
    <div className="relative w-16 h-16 md:w-20 md:h-20 mx-auto drop-shadow-xl transition-transform duration-300 shrink-0">
      {state === "idle" && (
        <svg viewBox="0 0 100 100" className="w-full h-full object-contain animate-bounce-soft">
      ...
      {state === "correct" && (
        <svg viewBox="0 0 100 100" className="w-full h-full object-contain animate-bounce-pop">
